  ...
  <body class="bg-gray-200 min-h-screen">
    <div class="mx-auto container py-20 px-6">
      <div class="w-full flex items-cente justify-between">
        <div>
          <h4 class="text-xs xl:text-base text-custom-1">Novembar 2022</h4>
        </div>
          ...
          <thead class="items-center">
            <tr class="h-20">
              <th class="px-10">
                <p
                  class="
                    text-xs text-left text-custom-3
                    uppercase
                    cursor-pointer
                  "
                >
              ...
              <td class="border-r relative border-gray-300">
                ...
                <div class="flex items-center -mt-16 absolute ml-4">
                  ...
                  <div class="ml-2">
                    ...
                    <p class="text-xs text-custom-blue mt-1">Online workshop</p>
                  </div>
                </div>
              </td>
              <td class="border-r border-gray-300">
              ...
              <td class="border-r relative xl:static border-gray-300">
                ...
                >
                  <div class="ml-1">
                    ...
                    <p class="text-xs text-custom-blue mt-0.5">
                      88innobiz Apply
                    </p>
                  </div>
                </div>
