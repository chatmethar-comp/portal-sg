<template>
  <div class="w-full">
    ...
    >
      <div
        class="
          ...
          md:items-stretch
          mx-auto
          border-b border-gray-200 border-opacity-20
        "
      >
        <div class="h-full flex items-center">
          ...
          >
            ...
            <div class="flex gap-3 items-center">
              <div class="text-4xl text-backgroundPrimary">P</div>
              <div class="text-xl text-backgroundPrimary font-bold">Portal</div>
            </div>
          </router-link>
        </div>
        <!-- End of Logo -->
        ...
        <!-- search bar -->
        <div class="h-full flex items-center justify-center lg:pr-40">
          <div class="relative">
            <!-- magnifier btn -->
            <div
              class="
            ...
            <!-- end of magnifier btn -->

            <!-- searchbar -->
            <input
              class="
                hidden
                bg-indigo-50 bg-opacity-10
                md:block
    ...
    <!-- Navbar Mobile -->
    <nav class="md:hidden">
      <div class="w-full shadow-md bg-darkPrimary fixed top-0 z-40">
        <div class="w-full flex md:hidden">
          <div class="py-4 flex justify-between mx-4 items-center w-full">
            <router-link
              ...
              role="img"
              tabindex="0"
              class="flex focus:outline-none my-2 items-center gap-3"
            >
              <div class="text-4xl text-white">P</div>
              <h1 class="text-xl text-white font-bold">Portal</h1>
            </router-link>
            <div class="flex md:hidden items-center justify-end">
              <div class="flex items-center">
                ...
                <router-link to="profile" class="h-full flex items-center">
                  <button
                    aria-label="dropdown"
                    class="
                      focus:outline-none
            ...
            <div class="flex flex-col justify-between h-full w-full">
              <div>
                ...
                <ul class="">
                  <div
                    class="
                      border-gray-200 border-b border-opacity-20
                      pb-5
                      md:pr-10
                      lg:pr-0
                      h-full
